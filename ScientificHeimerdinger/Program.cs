...
namespace HeimerdingerARK
{
    internal class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            combo.AddItem(new MenuItem("UseR", "Use R - Dynamic UPGRADE!!!Combo").SetValue(true));
            combo.AddItem(new MenuItem("UseQ", "Use Q - H-28G Evolution Turret").SetValue(true));
            combo.AddItem(new MenuItem("UseQR", "Use QR - Turret Combo").SetValue(true));
            combo.AddItem(new MenuItem("QRcount", "Enemy Count").SetValue(new Slider(2, 5, 1)));
            combo.AddItem(new MenuItem("Blank", "                                         "));
            combo.AddItem(new MenuItem("UseW", "Use W - Hextech Micro-Rockets").SetValue(true));
            combo.AddItem(new MenuItem("UseWR", "Use WR - Burst Combo").SetValue(true));
            combo.AddItem(new MenuItem("eBlank", "                                         "));
            combo.AddItem(new MenuItem("UseE", "Use E - CH-2 Electron Storm Grenade").SetValue(true));
            combo.AddItem(new MenuItem("UseER", "Use ER - Aoe Stun Combo").SetValue(true));
            combo.AddItem(new MenuItem("ERcount", "Stun Count").SetValue(new Slider(3, 5, 1)));

            combo.AddItem(new MenuItem("dBlank", "                                         "));
            combo.AddItem(new MenuItem("zhonyas", "Use Zhonyas").SetValue(true));
            combo.AddItem(new MenuItem("zhonyashp", "Own HP Percentage").SetValue(new Slider(30, 100, 0)));
            ...
            Config.SubMenu("Drawing").AddItem(new MenuItem("Qdraw", "Draw Q - H-28G Evolution Turret").SetValue(true));
            Config.SubMenu("Drawing").AddItem(new MenuItem("Wdraw", "Draw W - Hextech Micro-Rockets").SetValue(true));
            Config.SubMenu("Drawing")
                .AddItem(new MenuItem("Edraw", "Draw E - CH-2 Electron Storm Grenade").SetValue(true));
            Config.SubMenu("Drawing").AddItem(new MenuItem("ERdraw", "Draw ER - CH-3 Lightning Grenade").SetValue(true));
            ...
            void OnDraw(EventArgs args)
        {
            ...
            if (Config.Item("Wdraw").GetValue<bool>())
                if (W.Level > 0)
                    Utility.DrawCircle(ObjectManager.Player.Position, W.Range,
                        W.IsReady() ? Color.LightGoldenrodYellow : Color.Red);
            if (Config.Item("Qdraw").GetValue<bool>())
                if (Q.Level > 0)
                    Utility.DrawCircle(ObjectManager.Player.Position, Q.Range,
                        Q.IsReady() ? Color.LightGoldenrodYellow : Color.Red);
            ...
            if (Config.Item("ERdraw").GetValue<bool>())
                if (R.Level > 0)
                    Utility.DrawCircle(ObjectManager.Player.Position, E3.Range - 2,
